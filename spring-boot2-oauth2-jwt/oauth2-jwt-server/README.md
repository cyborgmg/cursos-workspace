...
```
em oauth2-jwt-server::resources

keytool -genkey -alias cyborg -keyalg RSA -validity 1825 -keystore "cyborg.jks" -storetype JKS -dname "CN=myserver.com,OU=My Company Name,O=My Organization,L=My Location,ST=My State,C=My Country Short Code" -keypass 123456 -storepass 123456

em oauth2-jwt-resource::resources

keytool -list -rfc -keystore cyborg.jks -alias cyborg -storepass 123456 | openssl x509 -inform pem -pubkey -noout

-----BEGIN PUBLIC KEY-----

/wIDAQAB
-----END PUBLIC KEY-----

copiar e salvar em public.txt
