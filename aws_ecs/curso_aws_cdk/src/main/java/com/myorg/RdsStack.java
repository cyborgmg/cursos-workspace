...
public class RdsStack extends Stack {
    ...
    private final static String databasePassword = "matilde123456";
    ...
    public RdsStack(final Construct scope, final String id, final StackProps props, Vpc vpc) {
                ...
                .credentials(
                        Credentials.fromUsername(
                                ...
                                CredentialsFromUsernameOptions.builder()
                                        .password(SecretValue.plainText(databasePassword/*databasePassword.getValueAsString()*/))
                                        .build()
                        )
                )
        ...
        CfnOutput.Builder
                ...
                .value(databasePassword/*databasePassword.getValueAsString()*/)
                .build();
    }
}
