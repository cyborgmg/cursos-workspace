...
public class Service01Stack extends Stack {
    ...
    public Service01Stack(final Construct scope, final String id, final StackProps props, Cluster cluster, SnsTopic productEventsTopic) {
        ...
        envVariables.put("SPRING_DATASOURCE_URL","jdbc:mariadb://"+Fn.importValue("rds-endpoint")+":3306/aws-project01?createDatabaseIfNotExist=true");
        ...
        ApplicationLoadBalancedFargateService service01 = ApplicationLoadBalancedFargateService
                ...
                .taskImageOptions(ApplicationLoadBalancedTaskImageOptions
                        ...
                        .image( ContainerImage.fromRegistry("cyborgmg/aws_project01:1.5.0"))
                        .containerPort(8080)
                        .logDriver(
                                LogDriver.awsLogs(
